        ...
        <div class="bg-white shadow-md rounded-3xl p-5">
            ...
            <form method="POST" action="{{ route('products.update') }}" enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    ...
                    <input value="{{ $product->price }}" type="number" name="product_price" id="idProductPrice" class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline"  required>
                </div>
